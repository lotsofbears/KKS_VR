...
namespace KKS_VR.Handlers
{
    ...
    internal class HandHolder : Holder
    {
        ...
        public void TestChangeCurrentRotOffset(float x, float y, float z)
        {
            _activeItem.rotationOffset = Quaternion.Euler(x, y, z);
        }
        /// <summary>
        ...
        private bool IsParent()
        {
            ...
            {
                if (child.name.EndsWith("Anchor", StringComparison.Ordinal))
                    return true;
            }
            return false;
        }
