...
namespace KKS_VR.Interactors
{
    internal class GraspHelper : MonoBehaviour
    {
        ...
        private readonly List<HitReaction.OffsetPlay> _transitionList = [];
        ...
        internal void StartTransition(BodyPart bodyPart)
        {
            ...
            _transitionList.Add(new HitReaction.OffsetPlay(bodyPart, bodyPart.anchor.localPosition, bodyPart.anchor.localRotation, bodyPart.chain != null));
            _transition = true;
        }
