...
namespace KKS_VR.Caress
{
    ...
    internal class CaressHelper : MonoBehaviour
    {
        ...
        public bool IsGripPress() => _device.Input.GetPress(k_EButton_Grip) || _device1.Input.GetPress(k_EButton_Grip);
        public bool IsTriggerPressUp() => _device.Input.GetPressUp(k_EButton_SteamVR_Trigger) || _device1.Input.GetPressUp(k_EButton_SteamVR_Trigger);
        public bool IsTriggerPressDown() => _device.Input.GetPressDown(k_EButton_SteamVR_Trigger) || _device1.Input.GetPressDown(k_EButton_SteamVR_Trigger);
